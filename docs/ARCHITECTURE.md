...
- `org.morok.settings` — версия схемы, настройки устройства и пространство настроек по устойчивому ID пользователя; строгий secret-free профиль переноса с отдельной версией формата.
