...
public class BuildVars {
    ...
    public static boolean CHECK_UPDATES = false; // MOROK must never install upstream APKs.
    public static boolean NO_SCOPED_STORAGE = Build.VERSION.SDK_INT <= 29;
    public static String BUILD_VERSION_STRING = BuildConfig.BUILD_VERSION_STRING;

    public static int APP_ID = BuildConfig.MOROK_API_ID;
    public static String APP_HASH = BuildConfig.MOROK_API_HASH;

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "";
    public static String PLAYSTORE_APP_URL = "https://github.com/haewho/morok";
    public static String HUAWEI_STORE_URL = "https://github.com/haewho/morok";
    public static String GOOGLE_AUTH_CLIENT_ID = BuildConfig.MOROK_GOOGLE_CLIENT_ID;
    ...
    public static String getSmsHash() {
        return BuildConfig.MOROK_SMS_HASH;
    }
}
