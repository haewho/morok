...
Собственная логика — в `org.morok`, вмешательства — в [HOOKS](docs/HOOKS.md). [Утверждённое ТЗ](docs/REQUIREMENTS.md) задаёт P0/P1/P2; его пункты не автоматически готовы. Память поддерживает ручные карточки, выключенный по умолчанию автоархив новых разрешённых сообщений только для явно выбранных чатов и явный импорт до 100 сообщений из уже существующего локального кеша выбранного чата. Полный device-тест архива, более глубокий импорт, APK-updater и остальные P1/P2 требуют следующих этапов.
