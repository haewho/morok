...
| Ghost preset, online/read/content-read/typing, исключения, local cursor | P0 | реализуется | Account-local Ghost preset и semantic suppression typing/recording/upload/sticker/emoji; online/read/content-read/исключения/cursor впереди; API terms conflict сохраняется |
