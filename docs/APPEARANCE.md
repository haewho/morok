...
Native entry: Telegram Settings → MOROK Settings. English and Russian strings live in separate MOROK resource files. The native screen has text search, named appearance modes, reviewed app profiles, Liquid Glass, reduced effects, Telegram themes and power-saving shortcuts, category reset, Memory and connection settings links. The separate transfer screen exports/imports reviewed MOROK appearance, round-video and global privacy flags without account/chat/proxy/archive/Memory data. Theme/AMOLED customization beyond Telegram’s existing theme UI remains pending.
