...
Собственная логика — в `org.morok`, вмешательства — в [HOOKS](docs/HOOKS.md). [Утверждённое ТЗ](docs/REQUIREMENTS.md) задаёт P0/P1/P2; его пункты не автоматически готовы. Память поддерживает ручные карточки и выключенный по умолчанию автоархив новых разрешённых сообщений только для явно выбранных чатов. Импорт старой истории, полный device-тест архива, APK-updater и остальные P1/P2 требуют следующих этапов.
