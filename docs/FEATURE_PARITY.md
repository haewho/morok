...
| Автоматический архив new/edit/delete/difference | P0 | требование | Надёжная проекция всех событий ещё не готова |
...
| Ghost preset, online/read/content-read/typing, исключения, local cursor | P0 | требование | Исходящее поведение пока штатное; API terms conflict не устраняется flavor |
